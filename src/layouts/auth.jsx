  ...
  return (
    <div className="lg:flex">
      <div className="lg:w-1/2 xl:max-w-screen-sm">
        <div className="py-8 bg-gray-100 flex justify-center lg:justify-start lg:px-12">
        ...
        <div className="mt-14 px-12 sm:px-24 md:px-48 lg:px-12 pb-20 lg:mt-16 xl:px-24 xl:max-w-2xl">
          <Outlet />
        </div>
      </div>
